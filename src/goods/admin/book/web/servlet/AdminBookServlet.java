...
public class AdminBookServlet extends BaseServlet {
	...
	public String load(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println(book.getCategory().getCname()+"------------");
	...
	public String addPre(HttpServletRequest req, HttpServletResponse resp)
		...
		List<Category> test=parents;
//		for(Category show:test){
...
//		}
	...
	public String findByCategory(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		int pc = getPc(req); //1. 得到pc：如果页面传递，使用页面的，如果没传，pc=1
		//System.out.println("这是一个pc："+pc+"=============================");
		String url = getUrl(req);//2. 得到url：...
		//System.out.println("这是一个url："+url+"=============================");
		String cid = req.getParameter("cid");//3. 获取查询条件，本方法就是cid，即分类的id
		//4. 使用pc和cid调用service#findByCategory得到PageBean
		PageBean<Book> pb = bookService.findByCategory(cid, pc);
		 //5. 给PageBean设置url，保存PageBean，转发到/jsps/book/list.jsp
		pb.setUrl(url);
		req.setAttribute("pb", pb);
		//System.out.println("这是一个pb："+pb.getUrl()+"+++++++++++++++++++++++++++++");
		//return null;
